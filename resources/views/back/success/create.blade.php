...
<div class="container">
    <div class="card shadow mb-4 border border-dark">
        ...
        <div class="card-body">
            <form action="{{route('successes.store')}}" method="POST" enctype="multipart/form-data" class="text-primary">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="uni" id="" class="form-control" autofocus value="{{old('uni')}}">
                    </div>
                </div><br><hr>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="faculty" id="" class="form-control" autofocus value="{{old('faculty')}}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="">Degree :</label>
                        <input type="text" name="degree" id="" class="form-control" autofocus value="{{old('degree')}}">
                    </div>
                </div><br><hr>
