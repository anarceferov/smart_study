...
<div class="container">
    <div class="card shadow mb-4 border border-dark">
        ...
        <div class="card-body">
            <form action="{{route('blogs.store')}}" method="POST" enctype="multipart/form-data" class="text-primary">
                @csrf
                <div class="form-group">
                    <label for="">Title :</label>
                    <input type="text" name="title" id="" class="form-control" autofocus value="{{old('title')}}">
                    <hr>
                </div>
                <div class="form-group">
